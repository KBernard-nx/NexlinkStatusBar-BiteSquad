...
public class PrefsHelper {
	...
	public PrefsHelper(Context context) {
		...
		notificationsEnabled = mSharedPrefs.getBoolean("notificationsEnabled", false);
		...
		optionsDisplay = mSharedPrefs.getBoolean("optionsDisplay", false);
		optionsBluetooth = mSharedPrefs.getBoolean("optionsBluetooth", false);
		optionsWifi = mSharedPrefs.getBoolean("optionsWifi", true);
		optionsMobile = mSharedPrefs.getBoolean("optionsMobile", false);
		optionsBattery = mSharedPrefs.getBoolean("optionsBattery", false);
		optionsLocation = mSharedPrefs.getBoolean("optionsLocation", false);
		optionsAirplane = mSharedPrefs.getBoolean("optionsAirplane", false);
		optionsSettings = mSharedPrefs.getBoolean("optionsSettings", false);
		...
		iconsNotification = mSharedPrefs.getBoolean("iconsNotification", false);
		iconsBluetooth = mSharedPrefs.getBoolean("iconsBluetooth", false);
		iconsWifi = mSharedPrefs.getBoolean("iconsWifi", true);
		iconsSignal = mSharedPrefs.getBoolean("iconsSignal", false);
		iconsVolume = mSharedPrefs.getBoolean("iconsVolume", false);
		iconsLocation = mSharedPrefs.getBoolean("iconsLocation", false);
	}
